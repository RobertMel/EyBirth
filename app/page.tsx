...
export default function Page() {
  ...
  return <main className="min-h-screen overflow-hidden bg-[#f5eddf] px-4 py-8 text-[#536755] sm:px-6"><div className="mx-auto max-w-xl"><div className="mb-7 flex items-center justify-between px-2"><span className="text-[10px] uppercase tracking-[0.28em] text-[#9a927f]">Invitation privée</span><span className="flex items-center gap-1.5 text-[10px] uppercase tracking-[0.18em] text-[#536755]"><CalendarDays size={13} /> 21.11.26</span></div><section className="relative overflow-hidden rounded-[2rem] border border-[#536755]/45 bg-[#fffaf1] px-6 py-10 text-center shadow-[0_18px_55px_rgba(83,103,85,0.14)] sm:px-12"><span className="corner-ribbon corner-ribbon-left" aria-hidden="true" /><span className="corner-ribbon corner-ribbon-right" aria-hidden="true" /><div className="pointer-events-none absolute inset-3 rounded-[1.6rem] border border-[#536755]/20" /><div aria-hidden="true" className="pointer-events-none absolute inset-0 z-0 select-none text-2xl">
      <span className="absolute top-3 right-3 rotate-12 opacity-50 text-xl">🦓</span>
      <span className="absolute bottom-4 right-3 -rotate-6 opacity-50 text-xl">🐘</span>
      <span className="absolute top-[29%] right-1 rotate-6 opacity-50 text-xl">🦓</span>
      <span className="absolute top-1 right-1 -rotate-3 opacity-50 text-xl">🦁</span>
      <span className="absolute top-[6%] left-1 rotate-12 opacity-50 text-xl">🦒</span>
      <span className="absolute bottom-2 right-4 rotate-6 opacity-50 text-xl">🦁</span>
      <span className="absolute bottom-3 right-1 rotate-12 opacity-50 text-xl">🐆</span>
      <span className="absolute bottom-8 left-1 -rotate-3 opacity-50 text-xl">🦓</span>
      <span className="absolute top-[16%] left-3 rotate-3 opacity-50 text-xl">🦍</span>
      <span className="absolute top-3 left-4 -rotate-6 opacity-50 text-xl">🦒</span>
      <span className="absolute bottom-6 right-3 rotate-6 opacity-50 text-xl">🦓</span>
      <span className="absolute top-[21%] left-2 -rotate-12 opacity-50 text-xl">🦒</span>
      <span className="absolute top-[18%] left-1 -rotate-6 opacity-50 text-xl">🦓</span>
      <span className="absolute top-8 left-2 rotate-3 opacity-50 text-xl">🦒</span>
      <span className="absolute top-[31%] left-3 rotate-3 opacity-50 text-xl">🦁</span>
