...
function RsvpForm() {
  ...
  return <form onSubmit={submit} className="mt-8 border-t border-[#b18b4d]/20 pt-8 text-left">
    <div className="mb-5 text-center"><p className="text-[10px] uppercase tracking-[0.28em] text-[#aa8249]">Votre réponse</p><h2 className="mt-2 font-serif text-2xl text-[#536755]">Serez-vous des nôtres ?</h2></div>
    ...
    <div className="mx-auto max-w-3xl">
      ...
      {guests === null ? (
        <form onSubmit={login} className="mx-auto max-w-sm rounded-3xl border border-[#d8ccb9] bg-[#fffaf1] p-8 text-center">
          <LockKeyhole size={22} className="mx-auto mb-4 text-[#aa8249]" />
        ...
        <>
          <div className="mb-9 flex items-end justify-between">
            <div><p className="text-[10px] uppercase tracking-[0.28em] text-[#aa8249]">Espace privé</p><h1 className="mt-2 font-serif text-4xl">Les invités</h1></div>
