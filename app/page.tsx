...
export default function Page() {
  ...
  return <main className="min-h-screen overflow-hidden bg-[#f5eddf] px-4 py-8 text-[#536755] sm:px-6"><div className="mx-auto max-w-xl"><div className="mb-7 flex items-center justify-between px-2"><span className="text-[10px] uppercase tracking-[0.28em] text-[#9a927f]">Invitation privée</span><span className="flex items-center gap-1.5 text-[10px] uppercase tracking-[0.18em] text-[#536755]"><CalendarDays size={13} /> 21.11.26</span></div><section className="relative overflow-hidden rounded-[2rem] border border-[#536755]/45 bg-[#fffaf1] px-6 py-10 text-center shadow-[0_18px_55px_rgba(83,103,85,0.14)] sm:px-12"><span className="corner-ribbon corner-ribbon-left" aria-hidden="true" /><span className="corner-ribbon corner-ribbon-right" aria-hidden="true" /><div className="pointer-events-none absolute inset-3 rounded-[1.6rem] border border-[#536755]/20" /><div aria-hidden="true" className="pointer-events-none absolute inset-0 z-0 select-none text-2xl">
      <span className="absolute top-[43%] left-[28%] rotate-12 opacity-50 text-xl">🦁</span>
      <span className="absolute top-[11%] left-[26%] rotate-6 opacity-50 text-xl">🦁</span>
      <span className="absolute top-[66%] left-[5%] -rotate-12 opacity-50 text-xl">🦓</span>
      <span className="absolute top-[55%] left-[18%] -rotate-12 opacity-50 text-xl">🦍</span>
      <span className="absolute top-[56%] left-[39%] -rotate-12 opacity-50 text-xl">🦒</span>
      <span className="absolute top-[82%] left-[39%] rotate-6 opacity-50 text-xl">🦓</span>
      <span className="absolute top-[8%] left-[5%] rotate-6 opacity-50 text-xl">🦒</span>
      <span className="absolute top-[39%] right-[12%] rotate-6 opacity-50 text-xl">🦁</span>
      <span className="absolute top-[75%] right-[38%] rotate-12 opacity-50 text-xl">🦒</span>
      <span className="absolute top-[15%] left-[26%] -rotate-12 opacity-50 text-xl">🦍</span>
      <span className="absolute top-[93%] left-[39%] -rotate-12 opacity-50 text-xl">🦍</span>
      <span className="absolute top-[28%] right-[37%] rotate-3 opacity-50 text-xl">🐘</span>
      <span className="absolute top-[61%] right-[26%] -rotate-3 opacity-50 text-xl">🦒</span>
      <span className="absolute top-[25%] left-[8%] rotate-6 opacity-50 text-xl">🐘</span>
      <span className="absolute top-[69%] right-[24%] rotate-12 opacity-50 text-xl">🦓</span>
